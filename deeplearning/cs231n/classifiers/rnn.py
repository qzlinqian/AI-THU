...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        # We provide the backward pass. You should implement the forward pass of the 
        # captioning model.
        # You should compute `temporal_affine_out` with `affine_forward, 
        # word_embedding_forward, rnn_forward, temporal_affine_forward`.
        # **** YOUR CODE HERE ****
